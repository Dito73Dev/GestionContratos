...
require_once("include/q_s_ctrl_pagado_001_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_s_ctrl_pagado_001" );
