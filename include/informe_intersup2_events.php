...
//$msg.= "Periodo: ".$values['inf_fecharep_i']." al ".$values['inf_fecharep_f']."\r\n";
//$msg.= "Asunto: ".$values['hr_asunto']."\r\n";
$msg.= "</br></br>Para atender este requerimiento ingrese a: http://gestion.mincit.gov.co/Athena/GestionContratos/\r\n";
//$msg.= "Age: ".$values["age"]."\r\n";
...
if ($data['inf_estado'] == 2 and $data['qty_inf'] == $data['qty_inf_verifica']){
