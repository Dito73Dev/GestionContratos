...
require_once("include/q_bandejaentrada_supervisores3_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_bandejaentrada_supervisores3" );
