	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "dbct_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "gestioncontratos_ver_103_audit", "varname" => "dbct_at_localhost__gestioncontratos_ver_103_audit", "altvarname" => "gestioncontratos_ver_103_audit", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "gestioncontratos_ver_103_locking", "varname" => "dbct_at_localhost__gestioncontratos_ver_103_locking", "altvarname" => "gestioncontratos_ver_103_locking", "connId" => "dbct_at_localhost", "schema" => "", "connName" => "dbct at 127.0.0.1");
		...
		if( "dbusers_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "gestioncontratos_ver_103_uggroups", "varname" => "dbusers_at_localhost__gestioncontratos_ver_103_uggroups", "altvarname" => "gestioncontratos_ver_103_uggroups", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "gestioncontratos_ver_103_ugmembers", "varname" => "dbusers_at_localhost__gestioncontratos_ver_103_ugmembers", "altvarname" => "gestioncontratos_ver_103_ugmembers", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
			$dalTables[$conn->connId][] = array("name" => "gestioncontratos_ver_103_ugrights", "varname" => "dbusers_at_localhost__gestioncontratos_ver_103_ugrights", "altvarname" => "gestioncontratos_ver_103_ugrights", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
