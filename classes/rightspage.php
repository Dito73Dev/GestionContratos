...
class RightsPage extends ListPage
{
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "gestioncontratos_ver_103_ugrights" )
	...
	function updateTablePermissions( $table, $group, $tableRights )
	{
		...
		$rightWTableName = $this->connection->addTableWrappers( "gestioncontratos_ver_103_ugrights" );
